...
## Logical Vector to keep only standard and mean columns
...
## Create creates a second independent tidy data set with the average of each variable for each activity and each subject
uS = unique(S)[,1]
nS = length(uS)
